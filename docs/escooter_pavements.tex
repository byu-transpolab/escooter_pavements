...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Measuring pavement smoothness using eScooters in Provo, Utah},
            colorlinks=false,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{Measuring pavement smoothness using eScooters in Provo, Utah}
    \author[BYU]{Gregory Macfarlane\corref{1}}
   \ead{gregmacfarlane@byu.edu} 
    \author[BYU]{Dylan Apelu}
  
    \author[BYU]{Nicole Adams}
  
    \author[BYU]{Liv Neeley}
  
    \author[BYUEE]{Stephen Brown}
  
    \author[BYUEE]{Brian Mazzeo}
  
    \author[BYU]{Spencer Guthrie}
  
      \address[BYU]{Civil and Construction Engineering Department, Brigham Young University, 430 Engineering Building, Provo, Utah 84602}
    \address[BYUEE]{Electrical and Computer Engineering Department, Brigham Young University, 410 Engineering Building, Provo, Utah 84602}
      \cortext[1]{Corresponding Author}
  
  \begin{abstract}
  This is where the abstract should go.
  \end{abstract}
   \begin{keyword} Pavement vibrations eScooters\end{keyword}
 \end{frontmatter}
